# Generated by Django 5.0.1 on 2024-04-20 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diseases', models.ManyToManyField(blank=True, to='base.disease')),
                ('medications', models.ManyToManyField(blank=True, to='base.medication')),
                ('prescription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.prescription')),
                ('vital_information', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.vitalinformation')),
            ],
        ),
        migrations.AddField(
